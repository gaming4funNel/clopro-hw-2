...
#!/bin/bash
cd /var/www/html
echo '<html><head><title>It's my picture</title></head> <body><h1>Look at hell!!!</h1><img src="http://${yandex_storage_bucket.ivanov-hw.bucket_domain_name}/1675373744_new_preview_kot.jpg"/></body></html>' > index.html
EOF
    }
  }
